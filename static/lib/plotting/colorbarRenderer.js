(function($) {
    ...
    $.jqplot.colorbarRenderer.prototype.init = function(options) {
        ...
        //this._yaxis.ticks = generate_ticks({min:display_dims.zmin, max: display_dims.zmax}, this.transform);
...
//                    [this.dims.xmin, this.dims.zmax]];
    ...
    $.jqplot.colorbarRenderer.prototype.get_sxdx = function(){
    ...
    // call with scope of series
    $.jqplot.colorbarRenderer.prototype.generate_cumsums = function () {
    ...
    $.jqplot.colorbarRenderer.prototype.draw_blit = function (ctx, gd, options) {
        var width = ctx.canvas.width;
        var height = ctx.canvas.height;
        ctx.clearRect(0,0, width, height);
