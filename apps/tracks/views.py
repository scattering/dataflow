...
def listWirings(request):
    print 'I am loading'
    return HttpResponse(simplejson.dumps(offspec+a+SANS))
...
def runReduction(request):
    print 'I am reducing'
####### SANS TESTING
    openFile =open('checkingSANSresults.txt','w')
    openFile.write(str(SANS_INS.TESTING()))
    openFile.close()
