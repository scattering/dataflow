...
class plot1D(object):
    ...
    def loads(cls, str): 
        return pickle.loads(str)
class div(object):
    """div object used to store contents of a DIV file.
       Using an object is necessary for plotting purposes. 
    """
...
def initial_correction(SAM,BGD,EMP,Trans):
    """ 
    Sample data is corrected for 
    background and empty cell scattering according to the algorithm:
